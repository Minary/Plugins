  ...
  public class HttpSearch
  {
    ...
    public void OnInit()
    {
      ...
      pluginBasedirectories.Add(Path.Combine(
                             ...
                             Plugin.Main.HttpSearch.DataTypes.General.PATTERN_DIR_REMOTE));

      pluginBasedirectories.Add(Path.Combine(
                             this.plugin.Config.ApplicationBaseDir,
                             this.plugin.Config.PluginBaseDir,
                             this.plugin.Config.PatternSubDir,
                             Plugin.Main.HttpSearch.DataTypes.General.PATTERN_DIR_LOCAL));

      pluginBasedirectories.Add(Path.Combine(
                             this.plugin.Config.ApplicationBaseDir,
                             this.plugin.Config.PluginBaseDir,
                             this.plugin.Config.PatternSubDir,
                             Plugin.Main.HttpSearch.DataTypes.General.PATTERN_DIR_TEMPLATE));
    ...
    private void CleanUpTemplateDir()
    {
      ...
      string[] patternFiles = Directory.GetFiles(templateDir, Plugin.Main.HttpSearch.DataTypes.General.PATTERN_FILE_PATTERN);
